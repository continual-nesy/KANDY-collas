...
commands = [
    ...
    "--cem_emb_size 12 --hamming_margin 2 --triplet_lambda 1.0 --concept_lambda 0.0 --use_mask no "
    "--concept_polarization_lambda 0.0 --mask_polarization_lambda 0.0 --min_pos_concepts 0 --n_concepts 30 "
    "--model cnn --output_folder exp --balance true --replay_buffer 200 --replay_lambda 10.0 --lr -0.01 "
