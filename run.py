...
commands = [
    ...
    "--print_every 32 --augment false --batch 16 --task_epochs 10 --train joint --seed 9101 "
    "--cem_emb_size 12 --hamming_margin 8 --triplet_lambda 1.0 --concept_lambda 1.0 "
    "--model cnn --output_folder exp --balance true --replay_buffer 0 --replay_lambda 0. --lr -0.0001  --device cuda:0",
]
